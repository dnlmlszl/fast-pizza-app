  ...
  return (
    <div className='py-6 px-4 space-y-6'>
      ...
      <ul className='divide-y divide-stone-200 border-b border-t'>
        {cart.map((order) => <OrderItem key={order.pizzaId} isLoadingIngredients={fetcher.state === 'loading'} item={order} ingredients={fetcher?.data?.find((el) => el.id === order.pizzaId)?.ingredients ?? []} />)}
